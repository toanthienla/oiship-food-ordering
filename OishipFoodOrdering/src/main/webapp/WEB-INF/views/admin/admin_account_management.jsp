                                ...
                                <tbody id="staffBody">
                                    <c:forEach var="account" items="${staffAccounts}">
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="${pageContext.request.contextPath}/admin/accounts?action=details&id=${account.accountID}&tab=${param.tab}&filterStatus=${param.filterStatus}&search=${param.search}" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#detailsModal-${account.accountID}">Details</a>
                            ...
                            <table class="table table-striped" id="customerTable">
                                ...
                                <tbody id="customerBody">
                                    ...
                                    <c:if test="${empty customerAccounts}">
                                        <tr><td colspan="5">No customer accounts found.</td></tr>
                                    </c:if>
                                </tbody>
                            </table>
                        </div>
