        ...
        <div class="main">
            <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
                <div class="container-fluid">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/admin/dashboard">Oiship</a>
            ...
            <div class="content mt-5">
                ...
                <div class="row mb-4 align-items-end">
                    ...
                    <div class="col-md-2 mt-3 mt-md-0 text-md-end">
                        <a href="${pageContext.request.contextPath}/admin/manage-orders/create-order" class="btn btn-success w-100">
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex justify-content-center align-items-center flex-wrap gap-2" style="min-width: 350px;">
                                            <a class="btn btn-sm btn-primary fw-semibold text-white"
                                               href="${pageContext.request.contextPath}/admin/manage-orders/update-status?orderID=${o.orderID}">
                                                Detail
                                            </a>
                                            <!-- Dropdown Update Status -->
                                            <form method="post" action="${pageContext.request.contextPath}/admin/manage-orders" style="display:inline-block;">
