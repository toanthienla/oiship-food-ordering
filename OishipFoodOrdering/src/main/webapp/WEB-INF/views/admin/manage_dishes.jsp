        ...
        <div class="main" id="main">
            ...
            <div class="content">
                ...
                <form action="manage-dishes" method="post" enctype="multipart/form-data" class="row g-3 mt-4">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">Operation Cost ($)</label>
                        <input type="number" step="0.01" class="form-control" name="opCost" required>
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <ul class="list-group mt-3">
                        <c:forEach var="dish" items="${dishes}">
                            <li class="list-group-item" style="cursor: pointer;" onclick="toggleDescription(this)">
                                <div class="d-flex justify-content-between align-items-center">
                                    <span>
                                        ${dish.dishName} - $${dish.opCost} + ${dish.interestPercentage}%
                                        (<c:out value='${dish.category.catName}' />)
                                    </span>
                                    <div>
                                ...
                                <div class="cat-description mt-1 text-muted" style="display: none;">
                                    <hr class="my-1" />
                                    Description: ${dish.dishDescription}<br />
                                    Image: <img src="${dish.image}" alt="${dish.dishName}" height="50" />
                                </div>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class="modal-dialog">
                <form action="manage-dishes" method="post" enctype="multipart/form-data" class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2">
                            <label class="form-label">Operation Cost</label>
                            <input type="number" step="0.01" class="form-control" id="editOpCost" name="opCost" required />
                        </div>
