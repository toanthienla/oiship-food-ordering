        ...
        <div class="login-card">
            <div class="p-4">
                <h2 class="text-center mb-3 fw-bold">
                    <i class="bi bi-box-arrow-in-right title-icon"></i> Welcome
                ...
                <p class="text-center text-muted mb-4">
                    ...
                    >
                        <i class="bi bi-person-plus title-icon"></i>Create a new
                        one
                    </a>
                </p>
                            ...
                            <div class="col-12 col-lg-5">
                                ...
                                >
                                    ...
                                    <div class="row gy-3">
                                        ...
                                        <div class="col-12">
                                            <button
                                                class="btn btn-login w-100 rounded-4 py-2"
                                                type="submit"
                                            >
                                                <i
                                                    class="bi bi-box-arrow-in-right title-icon"
                                                ></i
                                                >Log in
                                            </button>
                                        </div>
                        ...
                        <div class="row gy-4 justify-content-center">
                            ...
                            <div class="col-12 col-lg-5">
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <a
                                        href="https://www.facebook.com/v10.0/dialog/oauth?client_id=YOUR_FACEBOOK_APP_ID&redirect_uri=http://localhost:8080/SWPProject/login&scope=email,public_profile&state=admin"
                                        class="btn btn-outline-primary btn-social w-100 rounded-4 py-2"
                                    >
                                        <i class="bi bi-facebook title-icon"></i
                ...
                <div
                    ...
                    role="alert"
                >
                    <i class="bi bi-exclamation-circle title-icon"></i><%=
