...
<html lang="en">
    ...
    <body>
        ...
        <div class="sidebar">
            ...
            <a href="#dishes" class="active"><i class="fas fa-drumstick-bite me-2"></i> Dish</a>
        ...
        <div class="main-content">
            ...
            <div id="dishes" class="dish-section">
                ...
                <div class="dish-detail-container">
                    ...
                    <p><strong>Price:</strong> <%= dish.getFormattedPrice()%> đ</p>
                    ...
                    <div class="mt-5">
                        ...
                        <ul class="list-group mt-3">
                            ...
                            <li class="list-group-item">
                                <strong><%= r.getCustomerName()%></strong> - <%= r.getRating()%>  <span style="color: #ffb300; font-size: 1.5rem;">★</span> 
