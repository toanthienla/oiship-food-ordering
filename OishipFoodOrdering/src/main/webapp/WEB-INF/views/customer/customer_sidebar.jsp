...
<div class="sidebar d-flex flex-column justify-content-between" id="sidebar">
    <div class="sidebar">
        ...
        <a href="${pageContext.request.contextPath}/home"><i class="fas fa-utensils me-2"></i> Menu</a>
        <a href="${pageContext.request.contextPath}/home"><i class="fas fa-drumstick-bite me-2"></i> Dishes</a>
