...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Edit Profile - Oiship</title>
    ...
    <body>
                            ...
                            <div class="edit-form-card">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="last-updated">
                                        ...
                                        Last updated: 2025-07-31 07:21:05
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                console.log("Edit Profile page loaded - 2025-07-31 07:21:05 - User: toanthienla");
                ...
                form.addEventListener('submit', function (e) {
                    ...
                    if (!isValid) {
                        ...
                        console.log(`Profile update submitted by user: toanthienla at 2025-07-31 07:21:05`);
                    }
                });
