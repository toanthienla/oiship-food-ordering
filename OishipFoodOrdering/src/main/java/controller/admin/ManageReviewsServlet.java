 ...
 * @author HCT
 */
@WebServlet(name = "ManageReviewsAdminServlet", urlPatterns = {"/admin/manage-reviews"})
public class ManageReviewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/views/admin/manage_reviews.jsp").forward(request, response);
    }
