...
public class UpdateStatusOrderAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.printStackTrace();
            response.sendRedirect(request.getContextPath() + "/admin/manage-orders?error=invalidOrderID");
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/manage-orders/update-status?orderID=" + orderID);
